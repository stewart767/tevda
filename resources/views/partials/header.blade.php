        ...
        <div class="flex justify-between items-center h-20">
            ...
            <a href="{{ route('home') }}" class="flex items-center gap-3 group shrink-0">
                ...
                <div>
                    ...
                    <span class="text-[9px] sm:text-[10px] uppercase font-extrabold tracking-wider text-emerald-700 block mt-0.5">Tanzania EV Drivers Association</span>
                </div>
            </a>
            ...
            <nav class="hidden lg:flex items-center space-x-1 xl:space-x-1.5">
                ...
                <div class="relative" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                    ...
                    <div x-show="open" 
                        ...
                        <div class="px-3 py-1.5 mb-1 border-b border-slate-100">
                            <span class="text-[10px] font-extrabold uppercase tracking-wider text-slate-400">About TEVDA</span>
                        </div>
                        <a href="{{ route('about') }}" class="flex items-start gap-3 p-2.5 rounded-xl hover:bg-emerald-50/80 group transition">
                            ...
                            <div>
                                <div class="text-xs font-bold text-slate-800 group-hover:text-emerald-800">About TEVDA & SMART</div>
                                <div class="text-[11px] text-slate-500 font-normal">Our vision, core mission & mandate</div>
                            </div>
                        </a>
                        <a href="{{ route('leadership') }}" class="flex items-start gap-3 p-2.5 rounded-xl hover:bg-cyan-50/80 group transition">
                            ...
                            <div>
                                <div class="text-xs font-bold text-slate-800 group-hover:text-cyan-800">Governance & Leadership</div>
                                <div class="text-[11px] text-slate-500 font-normal">Board of Trustees & Secretariat</div>
                            </div>
                        </a>
                        <a href="{{ route('membership.info') }}" class="flex items-start gap-3 p-2.5 rounded-xl hover:bg-amber-50/80 group transition">
                            ...
                            <div>
                                <div class="text-xs font-bold text-slate-800 group-hover:text-amber-800">Membership Categories</div>
                                <div class="text-[11px] text-slate-500 font-normal">Driver tiers, benefits & requirements</div>
                            </div>
                        </a>
                        <a href="{{ route('partners') }}" class="flex items-start gap-3 p-2.5 rounded-xl hover:bg-indigo-50/80 group transition">
                            ...
                            <div>
                                <div class="text-xs font-bold text-slate-800 group-hover:text-indigo-800">Strategic Partners</div>
                                <div class="text-[11px] text-slate-500 font-normal">Government, financiers & EV allies</div>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="relative" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                    ...
                    <div x-show="open" 
                         ...
                         style="display: none;">
                        <div class="px-3 py-1.5 mb-1 border-b border-slate-100">
                            <span class="text-[10px] font-extrabold uppercase tracking-wider text-slate-400">Driver Initiatives</span>
                        </div>
                        <a href="{{ route('programmes') }}" class="flex items-start gap-3 p-2.5 rounded-xl hover:bg-emerald-50/80 group transition">
                            ...
                            <div>
                                <div class="text-xs font-bold text-slate-800 group-hover:text-emerald-800">Driver Programmes</div>
                                <div class="text-[11px] text-slate-500 font-normal">EV skills training & safety certification</div>
                            </div>
                        </a>
                        <a href="{{ route('projects') }}" class="flex items-start gap-3 p-2.5 rounded-xl hover:bg-teal-50/80 group transition">
                            ...
                            <div>
                                <div class="text-xs font-bold text-slate-800 group-hover:text-teal-800">EV Projects Showcase</div>
                                <div class="text-[11px] text-slate-500 font-normal">Fleet electrification & charging hubs</div>
                            </div>
                        </a>
                        <a href="{{ route('opportunities') }}" class="flex items-start gap-3 p-2.5 rounded-xl hover:bg-amber-50/80 group transition">
                            ...
                            <div>
                                <div class="text-xs font-bold text-slate-800 group-hover:text-amber-800">Opportunities Directory</div>
                                <div class="text-[11px] text-slate-500 font-normal">Driver jobs, fleet tenders & grants</div>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="relative" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                    ...
                    <div x-show="open" 
                         ...
                         style="display: none;">
                        <div class="px-3 py-1.5 mb-1 border-b border-slate-100">
                            <span class="text-[10px] font-extrabold uppercase tracking-wider text-slate-400">Knowledge & News</span>
                        </div>
                        <a href="{{ route('news') }}" class="flex items-start gap-3 p-2.5 rounded-xl hover:bg-sky-50/80 group transition">
                            ...
                            <div>
                                <div class="text-xs font-bold text-slate-800 group-hover:text-sky-800">News & Media Releases</div>
                                <div class="text-[11px] text-slate-500 font-normal">Updates, press releases & events</div>
                            </div>
                        </a>
                        <a href="{{ route('resources') }}" class="flex items-start gap-3 p-2.5 rounded-xl hover:bg-emerald-50/80 group transition">
                            ...
                            <div>
                                <div class="text-xs font-bold text-slate-800 group-hover:text-emerald-800">Resource Center</div>
                                <div class="text-[11px] text-slate-500 font-normal">Policy briefs, guidelines & downloads</div>
                            </div>
                        </a>
                        <a href="{{ route('whistleblower') }}" class="flex items-start gap-3 p-2.5 rounded-xl hover:bg-rose-50/80 group transition">
                            ...
                            <div>
                                <div class="text-xs font-bold text-slate-800 group-hover:text-rose-800">Whistleblower Portal</div>
                                <div class="text-[11px] text-slate-500 font-normal">Confidential reporting & transparency</div>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="relative" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                    ...
                    <div x-show="open" 
                        ...
                        <a href="{{ route('verify.membership') }}" class="flex items-start gap-3 p-2.5 rounded-xl hover:bg-emerald-50/80 group transition">
                            ...
                            <div>
                                <div class="text-xs font-bold text-slate-800 group-hover:text-emerald-800">Verify Member Status</div>
                                <div class="text-[11px] text-slate-500 font-normal">Check active registration & ID card</div>
                            </div>
                        </a>
                        <a href="{{ route('verify.certificate') }}" class="flex items-start gap-3 p-2.5 rounded-xl hover:bg-cyan-50/80 group transition">
                            ...
                            <div>
                                <div class="text-xs font-bold text-slate-800 group-hover:text-cyan-800">Verify Certificate</div>
                                <div class="text-[11px] text-slate-500 font-normal">Authenticate official certifications</div>
                            </div>
                        </a>
                    </div>
                </div>
            ...
            <div class="hidden md:flex items-center space-x-2.5">
                @auth
                    ...
                    <form method="POST" action="{{ route('logout') }}" class="inline">
                        @csrf
                        <button type="submit" class="text-xs text-slate-500 hover:text-rose-600 px-2.5 py-1.5 rounded-lg hover:bg-rose-50 font-medium transition" title="Log Out">
    ...
    <div x-show="mobileMenuOpen" 
        ...
        <div class="space-y-4">
            ...
            <div class="border-t border-slate-100 pt-3">
                <div class="text-[10px] font-extrabold uppercase tracking-wider text-slate-400 px-3.5 mb-1.5">About TEVDA</div>
                <div class="space-y-1">
            ...
            <!-- Programmes & Projects -->
            <div class="border-t border-slate-100 pt-3">
                <div class="text-[10px] font-extrabold uppercase tracking-wider text-slate-400 px-3.5 mb-1.5">Programmes & Projects</div>
                <div class="space-y-1">
                    <a href="{{ route('programmes') }}" class="flex items-center gap-2.5 px-3.5 py-2 rounded-xl text-xs font-semibold text-slate-700 hover:bg-emerald-50 hover:text-emerald-700">
                        <span class="w-1.5 h-1.5 rounded-full bg-emerald-500"></span>
                        <span>Driver Training Programmes</span>
                    </a>
                    <a href="{{ route('projects') }}" class="flex items-center gap-2.5 px-3.5 py-2 rounded-xl text-xs font-semibold text-slate-700 hover:bg-emerald-50 hover:text-emerald-700">
                        ...
                        <span>EV Projects Showcase</span>
                    </a>
            ...
            <!-- Media & Resources -->
            <div class="border-t border-slate-100 pt-3">
                <div class="text-[10px] font-extrabold uppercase tracking-wider text-slate-400 px-3.5 mb-1.5">Media & Resources</div>
                <div class="space-y-1">
                    ...
                    <a href="{{ route('resources') }}" class="flex items-center gap-2.5 px-3.5 py-2 rounded-xl text-xs font-semibold text-slate-700 hover:bg-emerald-50 hover:text-emerald-700">
                        <span class="w-1.5 h-1.5 rounded-full bg-emerald-500"></span>
                        <span>Resource Center & Downloads</span>
                    </a>
            ...
            <div class="pt-4 border-t border-slate-100 flex flex-col gap-2">
                @auth
                    <a href="{{ auth()->user()->isStaff() ? route('admin.dashboard') : route('portal.dashboard') }}" class="w-full text-center bg-emerald-600 text-white font-bold py-3 rounded-xl shadow-md">
                        Go to {{ auth()->user()->isStaff() ? 'Admin Suite' : 'Member Portal' }}
                    </a>
                    <form method="POST" action="{{ route('logout') }}" class="w-full">
                        @csrf
                        <button type="submit" class="w-full text-center py-2 text-xs text-slate-500 hover:text-rose-600 font-medium">Log Out</button>
                    </form>
                @else
                    <a href="{{ route('register') }}" class="w-full text-center bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-extrabold py-3 rounded-xl shadow-md text-sm">Join TEVDA Today</a>
                    <a href="{{ route('login') }}" class="w-full text-center border border-slate-200 text-slate-700 font-bold py-2.5 rounded-xl text-xs hover:bg-slate-50">Log In to Portal</a>
                @endauth
            </div>
        </div>
    </div>
